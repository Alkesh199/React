    ...
    return(
        <div className="max-w-[1320px] m-auto px-8 ">
             <div className ="flex items-center justify-between border-b-2 border-b-gray-700">
                ...
                {!isVisible && <button onClick={()=>setIsVisible(true)} className=" text-orange-900 font-bold text-xl w-8">&#43;show</button>}
                { isVisible && <button onClick={()=>setIsVisible(false)} className="text-orange-900 font-bold text-xl w-8">&#45;hide</button>}
             </div>
