...
export const Footer = () =>{
    ...
    return (
        ...
        <div className="flex max-w-[1320px] justify-center  items-start mx-auto  text-white py-14 border-b-2 border-white">
            <div className="w-[20%]">
        ...
        <div className="flex items-center justify-between text-white mx-auto max-w-[1320px] py-12">
            <Title></Title>
            <div><p className = "font-normal text-base"><span className = "font-bold text-lg"> © 2023 </span>Food Villa</p></div>
            <div className="flex justify-around mr-[12%]">
               <a href="https://www.facebook.com/profile.php?id=100008755813617" target="_blank" className="hover:animate-pulse"><img src={facebookLogo} alt="facebook logo" className="max-h-10"></img></a>
            <a href="https://www.instagram.com/__a__k__y/" target="_blank" className="hover:animate-pulse"><img src={instaLogo} alt="insta logo" className="max-h-10 mx-6"></img></a>
            <a href="https://www.linkedin.com/in/alkesh-yadav-9720b7165/" target="_blank" className="hover:animate-pulse"> <img src={linkedinLogo} alt="twitter logo" className="max-h-10 "></img></a>
            </div>
        </div>

        <div className="pb-14 max-w-[1320px] m-auto flex items-center">
            <p className="text-white">This site is developed by <span className="font-bold animate-pulse text-lime-700">{user.name}: {user.email}</span></p>
        </div>
        </div>
