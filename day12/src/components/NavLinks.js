    ...
    return(
        <>
           <Link to="/"><li className="text-lg text-white  hover:text-orange-700 hover:font-bold">Home</li></Link>
                ...
                <Link to="cart" className="hidden lg:flex"><li className="text-lg  text-white hover:text-orange-700 hover:font-bold">cart <span className="px-2 py-1 !text-red font-bold border border-red-700 rounded ">{cartS.count}</span></li></Link>
